...
describe('Pruebas en SearchScreen', () => { 
    ...
    test('should mostrar de manera correctamente con valores por defecto', () => { 
    ...
    test('should mostrar un error si no se encuentra el error si no se encuentra el hero', () => { 
